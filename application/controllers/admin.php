...
class Admin extends CI_Controller
{
   ...
   {  
      ...
      $this->load->view('templatesadmin/vsidebaruser');
      $this->load->view('templatesadmin/vadmin',$data);
   ...
   {   
     ...
     // $data['penyewa']=$this->db->query("SELECT * FROM penyewa where id_penyewa='id_penyewa'")->result();
      ...
      $this->load->view('templatesuser/vheaderuser',$dtitle);
      $this->load->view('templatesadmin/vsidebaruser');
      $this->load->view('templatesadmin/veditprofil',$data);
      $this->load->view('templatesuser/vfooteruser');
   }
   ...
   'Foto ',
    ...
    [
      ...
      {   
         ...
         $this->load->view('templatesuser/vheaderuser',$dtitle);
         $this->load->view('templatesadmin/vsidebaruser');
         $this->load->view('templatesadmin/vgantipwd');
         $this->load->view('templatesuser/vfooteruser');
      }
      ...
      public function aksi_gantipwd()
      {
         ...
         if ($this->form_validation->run()== FALSE){
            ...
            redirect('admin/gantipwd');
         }    

      }
   //function untuk menampilkan data penyewa   
   public function tampil_pen()
      {
      $data['penyewa']=$this->db->get_where('penyewa',['id_penyewa'=> $this->session->userdata('id_penyewa')])->row_array();
      $daftar['penyewa']= $this->madmin->getadmin('penyewa')->result();
      $title['title']='Kos kita-Daftar Data Penyewa';
      $this->load->view('templatesuser/vheaderuser',$title);
      $this->load->view('templatesadmin/vsidebaruser');
      $this->load->view('templatesadmin/vdatapen',$data);
      $this->load->view('templatesuser/vfooteruser');
