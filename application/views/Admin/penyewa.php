        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <div class="sidebar">
               ...
               with font-awesome or any other icon font library -->
                        ...
                        <li class="nav-item has-treeview menu-open">
                            <a href="<?= base_url('home1/penyewa') ?>" class="nav-link active">
                                        ...
                                        <tbody>
                                            <?php foreach ($penyewa as $data) : ?>
                                                <tr>
                                                    ...
                                                    <td><a href="<?= base_url('home1/hapus_penyewa/') . $data['id_penyewa'] ?>" onclick="return confirm('Apakah anda Yakin ?')" class=" badge badge-danger">Hapus</a>
                                                    </td>
                                                </tr>
                                            <?php endforeach; ?>
                                        </tbody>
