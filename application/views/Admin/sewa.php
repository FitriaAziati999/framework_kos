        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <div class="sidebar">
               ...
               with font-awesome or any other icon font library -->
                        ...
                        <li class="nav-item has-treeview menu-open">
                            <a href="<?= base_url('home1/sewa') ?>" class="nav-link active">
                                        ...
                                        <tbody>
                                            <?php foreach ($sewa as $data) : ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="<?= base_url('home1/update_sewa/') . $data['id_sewa'] ?>" onclick="return confirm('Apakah anda Yakin ?')" class=" badge badge-<?= $data['status'] == 'Terverifikasi' ? 'success' : 'danger' ?>"><?= $data['status']; ?></a>
                                                    </td>
                                                </tr>
                                            <?php endforeach; ?>
                                        </tbody>
