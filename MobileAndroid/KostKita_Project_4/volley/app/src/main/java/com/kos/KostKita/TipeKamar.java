...
public class TipeKamar extends AppCompatActivity {
    ...
    String URL_UPDATE = "http://192.168.100.35/framework_kos/index.php/tipe/update";
    String URL_TAMPIL = "http://192.168.100.35/framework_kos/index.php/tipe/id";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Ukuran = (TextView)findViewById(R.id.profilemail);
        Stok = (TextView) findViewById(R.id.textnama);
        Harga = (TextView) findViewById(R.id.textEmail);
        Kapasitas  = (TextView) findViewById(R.id.textUsername);
        Fasilitaskamar  = (TextView) findViewById(R.id.textAlamat);
...
//        EmailProfil.setText(EmailProfil.getText() + TempHolder);
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, URL_TAMPIL,
                        ...
                        try{
                            ...
                            if (message.equals("success")){
                                ...
                                for (int i=0; i < jsonArray.length(); i++){
                                    ...
                                    String strKapasitas = object.getString("penghuni").trim();
                                    ...
                                    Kapasitas.setText(strKapasitas);
                                    Fasilitaskamar.setText(strFasilitaskamar);

                                }
                            } else {
                                progressDialog.dismiss();
                                Toast.makeText(TipeKamar.this, message, Toast.LENGTH_SHORT).show();
                            }
                        } catch (JSONException e){
                            e.printStackTrace();
                            progressDialog.dismiss();
                            Toast.makeText(TipeKamar.this, "Error "+e.toString(), Toast.LENGTH_SHORT).show();
                        }
                    }
                },
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        progressDialog.dismiss();
                        Toast.makeText(TipeKamar.this, "Error "+error.toString(), Toast.LENGTH_SHORT).show();
                    }
                })
        {
            @Override
    ...
    private void Update() {
        ...
        final String Kapasitas = this.Kapasitas.getText().toString().trim();
