...
public class Notif_Model {
    ...
    public String getMasuk_kos() { return masuk_kos; }

    public void setMasuk_kos(String masuk_kos) { this.masuk_kos = masuk_kos; }

    public String getNopen() { return nopen; }

    public void setNopen(String nopen) { this.nopen = nopen; }
}
