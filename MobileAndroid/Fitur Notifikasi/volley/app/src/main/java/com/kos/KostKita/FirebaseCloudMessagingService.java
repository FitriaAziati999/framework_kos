...
//        dispatcher.schedule(myJob);
    ...
    private void showNotification(String title, String message) {
        ...
        NotificationManager notificationManager = (NotificationManager) getSystemService(Context.NOTIFICATION_SERVICE);
        String NOTIFICATION_CHANNEL_ID = "my_channel_id_01";
        Intent notificationIntent = new Intent(getBaseContext(), NotifikasiActivity.class);
        notificationIntent.putExtra("kd_transaksi", key);
    ...
    private class GooglePlayDriver {
        public GooglePlayDriver(FirebaseCloudMessagingService firebaseCloudMessagingService) {
        }
    }
